...
const ProductDetailPage = () => {
  ...
  const { selectedSize, quantity, setSelectedSize, setQuantity, resetProductState } = useProduct();
                ...
                <div className="grid grid-cols-4 gap-2 mt-2">
                  {product.sizes.map((size) => (
                    <Button
                      ...
                      className={`relative ${selectedSize === size ? 'ring-2 ring-offset-2 ring-blue-500' : ''}`}
                      onClick={() => {
